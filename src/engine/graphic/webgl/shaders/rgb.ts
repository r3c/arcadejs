...
const linearToStandard = createSingletonFunction<[string]>(
  shader`\
...
const luminance = createSingletonFunction<[string]>(
  shader`\
...
const standardToLinear = createSingletonFunction<[string]>(
  shader`\
