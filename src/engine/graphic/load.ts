...
const finalizeMesh = (mesh: model.Geometry, config: Config) => {
  ...
  } else mesh.normals = computeNormals(mesh.indices, mesh.points);
  ...
  if (mesh.tangents !== undefined) {
    ...
    const count = mesh.tangents.stride;
...
const finalize = async (
  meshPromise: Promise<model.Mesh>,
