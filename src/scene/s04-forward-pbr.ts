...
const prepare = async () => application.runtime(display.WebGLScreen, configuration, async (screen, input, tweak) => {
	...
	// Load textures
	const brdf = webgl.loadTextureQuad(gl, await image.loadFromURL("./obj/ibl_brdf_lut.png"));

	const diffuse = webgl.loadTextureCube(gl,
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/diffuse/diffuse_right_0.jpg"),
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/diffuse/diffuse_left_0.jpg"),
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/diffuse/diffuse_top_0.jpg"),
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/diffuse/diffuse_bottom_0.jpg"),
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/diffuse/diffuse_front_0.jpg"),
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/diffuse/diffuse_back_0.jpg")
	);

	const specular = webgl.loadTextureCube(gl,
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/specular/specular_right_0.jpg"),
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/specular/specular_left_0.jpg"),
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/specular/specular_top_0.jpg"),
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/specular/specular_bottom_0.jpg"),
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/specular/specular_front_0.jpg"),
		await image.loadFromURL("https://raw.githubusercontent.com/KhronosGroup/glTF-WebGL-PBR/master/textures/papermill/specular/specular_back_0.jpg")
	);
	...
	return {
		...
		input: input,
		lights: functional.range(3, i => ({ position: { x: 0, y: 0, z: 0 } })),
		meshes: {
		...
		projectionMatrix: matrix.Matrix4.createPerspective(45, screen.getRatio(), 0.1, 100),
...
const render = (state: SceneState) => {
	...
	const lightPositions = state.lights.slice(0, state.tweak.nbLights).map(light => light.position);
	...
	pipelines.lights[bitfield.index(getOptions(state.tweak))].process(target, {
